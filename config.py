...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://jnassets75:YHoC7VLoGzvuSknay@cluster0.crje9co.mongodb.net/?retryWrites=true&w=majority")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002091945545")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('TECH_VJ_UPDATES_CHANNEL', '-1002005042827') # your update channel id and make bot admin in update channel with full right
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', 'zu1xmKAMdlguQSBt5c8ais2aV212') # your url shortner api
